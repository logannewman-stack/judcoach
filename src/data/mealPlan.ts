...
export const MEAL_PLAN: MealPlan = {
  ...
  targets: { kcal: 2920, protein: 247, carbs: 283, fat: 89, fiber: 38, waterOz: 128 },
  restDayTargets: { kcal: 2570, protein: 247, carbs: 195, fat: 89, fiber: 38, waterOz: 120 },
  guidelines: [
  ...
  meals: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          qty: 60,
          unit: 'g',
          kcal: 228, protein: 8, carbs: 41, fat: 4,
          swaps: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'm2-honey', name: 'Honey', qty: 20, unit: 'g', kcal: 68, protein: 0, carbs: 17, fat: 0 },
        {
          ...
          qty: 20,
          unit: 'g',
          kcal: 122, protein: 4, carbs: 4, fat: 10,
          swaps: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          qty: 200,
          unit: 'g',
          kcal: 257, protein: 5, carbs: 57, fat: 1,
          swaps: [
        ...
        { id: 'm3-broccoli', name: 'Broccoli', qty: 200, unit: 'g', kcal: 73, protein: 6, carbs: 10, fat: 1 },
      ...
      items: [
        {
          ...
          qty: 4,
          unit: 'cakes',
          kcal: 141, protein: 3, carbs: 30, fat: 1,
          swaps: [
        ...
        { id: 'm4-banana', name: 'Banana', qty: 1, unit: 'medium', kcal: 112, protein: 1, carbs: 27, fat: 0 },
        {
          id: 'm4-whey',
          name: 'Whey protein',
          qty: 1,
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          qty: 300,
          unit: 'g',
          kcal: 263, protein: 6, carbs: 53, fat: 3,
          swaps: [
        ...
        { id: 'm5-salad', name: 'Green salad + dressing', qty: 1, unit: 'bowl', kcal: 122, protein: 2, carbs: 6, fat: 10 },
      ],
    },
    {
      id: 'meal-6',
      ...
      items: [
        ...
        { id: 'm6-pb', name: 'Peanut butter', qty: 16, unit: 'g', kcal: 100, protein: 4, carbs: 3, fat: 8 },
      ],
    },
  ],
}
